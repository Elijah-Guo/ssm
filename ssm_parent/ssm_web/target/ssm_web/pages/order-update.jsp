					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="订单编号"
								value="${order.orderNum }" name="orderNum" readonly="readonly">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a3" name="orderTime" value="${order.orderTime}">
							</div>
						</div>
						<div class="col-md-2 title">路线名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="路线名称"
								value="${order.product.productName }" name="product.productName">
						</div>

						<div class="col-md-2 title">出发城市</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="路线名称"
								value="${order.product.cityName }" name="product.cityName">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a6" value="${order.product.departureTime }" name="product.departureTime">
							</div>
						</div>
						<div class="col-md-2 title">出游人数</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="出游人数"
								value="${order.peopleCount}" name="peopleCount">
						</div>
				...
				<c:if test="${orders.orderStatus==1}">
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data text">在线支付-<input type="text" value="${orders.payType}" name="payType"></div>
