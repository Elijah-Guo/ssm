...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/product/update.do"
				method="post">
				<h1>显示商品的状态为:${product.productStatus}</h1>
	...
	<script>
		/*js和jq的结合使用*/
		/*更新中的产品状态并不是动态的，点击更新页面默认的产品状态信息应该是数据库中已有信息的状态
		二者应该保持一致,所有利用点击按钮传来的产品信息，匹配当前页面显示的产品状态*/
        $("#productStatus option[value='${product.productStatus}']").prop("selected",true);
	</script>
	<script
